    ...
    <body>
        <div class="relative md:border-0 border">
            <div class="flex relative justify-between p-4 w-full z-10 items-center flex-wrap grow-0 md:mb-4 mb-2">
                ...
                <a class="inline-block mb-4" href="{{route('index')}}"><h2 class="md:text-2xl md:mt-0 md:mb-0 mb-4 text-lg tracking-wider font-medium absolute left-0 right-0 ml-0 mr-0 text-center">Школа Полтавского</h2></a>
