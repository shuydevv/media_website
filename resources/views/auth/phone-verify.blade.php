...
<div class="max-w-md mx-auto px-4 pt-16 pb-8">
  ...
  <div class="bg-white border rounded-2xl p-6 shadow-sm">
    <h1 class="text-2xl font-semibold sans mb-2">Введите код</h1>
    <p class="text-sm text-gray-600 mb-6">Мы отправили код на {{ session('masked_phone') }}</p>
    ...
    <div class="mt-6 pt-6 border-t border-gray-200 text-center">
      <form method="post" action="{{ route('auth.phone.resend') }}">
        @csrf
        <button class="link-custom text-sm text-blue-700" type="submit">Отправить код снова</button>
      </form>
    </div>
  </div>
</div>
