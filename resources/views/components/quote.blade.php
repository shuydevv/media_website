    ...
    <div class="rounded-lg border p-4 md:mt-16 mt-10 md:mb-20 mb-12 flex justify-center flex-col items-center">
        <img class="md:mb-3 mb-1" src="{{asset('img/quote.svg')}}" alt="quote">
        <p class="text-center italic text-lg sans font-medium text-zinc-900">{{$text}}</p>
        <div class="mt-6 flex justify-center flex-col items-center">
            ...
            <p class="not-italic text-base text-zinc-400 text-center">{{$description}}<p>
        </div>
    </div>
    {{-- </div> --}}